import { Calendar, LogOut, Users, ShieldUser } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
export function AppSidebar() {
        ...
        <SidebarContent className="flex flex-col justify-between h-full">
          ...
          <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                    onClick={() => logout()}
                    className="flex items-center gap-3 px-4  text-red-600 hover:bg-red-50 hover:text-red-700 rounded-md transition-colors w-full"
                >
            ...
            <div className="flex items-center gap-3 px-3 bg-gray-50 rounded-lg">
  ...
  {loggedInUser?.roles && loggedInUser.roles.length > 0
